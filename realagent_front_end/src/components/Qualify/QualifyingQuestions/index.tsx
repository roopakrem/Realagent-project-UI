import { useMantineTheme, Flex, TextInput, Textarea, Divider } from "@mantine/core";
...
import { CreateQualifyingQuestionFormData, qualifyingQuestionAPI } from "../../../store/features/DataSources/DataSourceAPI/qualifyingQuestionAPI";
...
const Qualifyquestions: React.FC = () => {
  ...
  return (
    <div>
      <Flex>
        <Flex w={'45%'} direction={'column'} gap={'24px'} style={{marginTop: '20px'}}>
          <TextInput
            variant="filled"
            label="Add Question"
        ...
        <Flex w={'65%'} direction={'column'} gap={'24px'} style={{marginTop: '20px'}}>
