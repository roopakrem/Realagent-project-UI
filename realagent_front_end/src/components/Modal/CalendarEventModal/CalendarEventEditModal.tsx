...
const CalendarEventEditModal: React.FC<CalendarEventModalProps> = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <Modal opened={isOpen} onClose={onClose} p={0} styles={{ body: { padding: 0 } }} title="Update Calendar Event">
      <Stack gap="md" p={0}>
        <TextInput
          px={20}
          label="Event Summary"
