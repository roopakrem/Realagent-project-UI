...
import styles from './ResearchPostModal.module.css';
...
export interface SocialMedia_ResearchPostData {
  id?: string;
  image?: string;
  post: string;
  hashtags: string;
...
interface PostModalProps {
  opened: boolean;
  data: SocialMedia_ResearchPostData;
  setData: React.Dispatch<React.SetStateAction<SocialMedia_ResearchPostData>>;
  onClose: () => void;
  onSave: () => void;
}
...
export const ResearchSocialPostModal: React.FC<PostModalProps> = ({
  opened,
  data,
  setData,
  onClose,
  ...
  const handleOnSave = async () => {
    ...
    try {
      ...
      await socialMediaAgentAPI.sendSocialMediaPost({
