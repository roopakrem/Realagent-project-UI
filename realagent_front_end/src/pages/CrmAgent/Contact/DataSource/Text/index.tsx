...
import { getAllParagraphs } from "../../../../../store/features/DataSources";
...
const TextDataSource: React.FC = () => {
  ...
  const allParagraphs = useAppSelector(
    (state) => state.dataSources.allParagraphs
  );
          ...
          {allParagraphs.map((paragraph) => (
            ...
            >
              <Textarea
                ...
                value={
                  editingId === paragraph._id ? editContent : paragraph.content
                }
              ...
              {editingId === paragraph._id ? (
                ...
                <>
                  <EditButton
                    ...
                    onClick={() =>
                      onParagraphEdit(paragraph._id, paragraph.content)
                    }
                  />
                  <WithModal
