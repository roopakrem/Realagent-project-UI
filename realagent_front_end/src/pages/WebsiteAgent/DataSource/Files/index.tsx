...
import { getDataSourceFiles, removeFile, uploadDataSourceFile, uploadFile } from '../../../../store/features/fileHub';
import { toast } from 'sonner';
import { fileHubAPI, FileUploadResponse } from '../../../../store/features/fileHub/fileHubAPI';
...
import { fetchDatasource } from '../../../../store/features/DataSources';
...
const FilesDataSource: React.FC = () => {
  ...
  const handleDeleteFile = (e?: React.MouseEvent<HTMLButtonElement>) => (file: FileUploadResponse) => {
    e?.preventDefault();
    e?.stopPropagation();
  ...
  return (
    <div>
      <Flex w={'100%'}>
        <Flex w={'50%'} direction={'column'} gap={'24px'} px={'10px'}>
          <CustomDropzone
            openRef={openRef}
